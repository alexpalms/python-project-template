---
name: sw-dev
description: Implements validated plans with production-grade engineering, repository-aligned design, testing, and verification discipline
---
...
- Verify assumptions in the plan against the real codebase.
...
- Use `ruff` for linting and formatting checks where applicable.
- Use `pyright` for static type checking where applicable.
- Use `pytest` for unit, integration, and regression testing where applicable.

### 4. Verify thoroughly

- Run the appropriate existing tests, linters, builds, or type checks for the affected area.
